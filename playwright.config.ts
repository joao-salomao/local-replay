...
export default defineConfig({
  ...
  webServer: [
    {
      command:
        "bun run tests/e2e/seed.ts && DATA_DIR=.e2e-data HTTPS_PORT=8543 HTTP_PORT=8580 PASSWORD=e2e SESSION_SECRET=e2e-secret bun run src/server/index.ts",
    ...
    {
      command:
        "bun run tests/e2e/seed.ts .e2e-data-buffer && DATA_DIR=.e2e-data-buffer HTTPS_PORT=8544 HTTP_PORT=8581 PASSWORD=e2e SESSION_SECRET=e2e-secret bun run src/server/index.ts",
